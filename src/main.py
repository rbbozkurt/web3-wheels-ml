...
def simulate_map_passenger_vehicle(
    ...
    for _ in range(n_vehicle):
        vehicle_nodes.append(get_random_nodes(map_G, with_data=False))

    passenger_nodes = []
    for _ in range(n_passenger):
        passenger_nodes.append(get_random_nodes(map_G, with_data=False))
    ...
    draw_passengers_and_vehicles(
        map_G,
        pre_ax=ax,
        vehicles_node_ids=vehicle_nodes,
        passengers_node_ids=passenger_nodes,
    )
